...
```text
├── wechat_cleaner.py  # 图形界面主程序
├── scanner.py         # 扫描算法、哈希计算、模糊逻辑
...
本项目Fork自 [loivon/WeChat_duplicate_file_cleanup_tools](https://github.com/loivon/WeChat_duplicate_file_cleanup_tools)，并在其基础上进行了不算小的重构与功能增强。
